  ...
  return (
    <div>
      <div className="flex justify-between mb-1 text-sm">
        ...
        <span className="font-bold text-gray-900">{score ?? "—"}/90</span>
      </div>
...
export default function MockTestReportPage() {
  ...
  return (
    <>
      ...
      <div ref={reportRef} className="mx-auto max-w-2xl space-y-6 bg-white p-8 rounded-2xl border shadow-sm">
        {/* Header */}
        <div className="text-center border-b pb-6">
          <h1 className="text-2xl font-bold text-gray-900">Prepfly PTE Score Report</h1>
        ...
        {/* Section Scores */}
        <div>
          <h2 className="text-base font-semibold text-gray-800 mb-4">Section Scores</h2>
        ...
        {/* Stats */}
        <div className="grid grid-cols-3 gap-4 rounded-xl border p-4 text-center">
          <div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Time Taken</p>
          </div>
        </div>
