                ...
                return (
                  <div key={q.id} className="flex items-center justify-between p-4 hover:bg-gray-50">
                    ...
                    <div className="flex items-center gap-1">
                      <button className="rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-blue-600">
                        <Edit2 className="h-4 w-4" />
                      </button>
                      <button className="rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-red-600">
